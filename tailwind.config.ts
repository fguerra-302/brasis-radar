	...
	theme: {
    	...
    	extend: {
    		...
    		colors: {
    			...
    			terracotta: 'hsl(var(--brasis-terracotta))',
    			'terracotta-foreground': 'hsl(var(--brasis-terracotta-foreground))',
    			sage: 'hsl(var(--brasis-sage))',
    			'sage-foreground': 'hsl(var(--brasis-sage-foreground))',
    			},
    			sidebar: {
